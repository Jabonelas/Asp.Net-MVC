...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            ViewData["Resultado"] =
                $"{files.Count} arquivos foram enviados ao servidor, com tamanho total de: {size} bytes";

            ViewBag.Arquivo = filePathsName;
        ...
        {
            string _imagemDelete = Path.Combine(_hostingEnvironment.WebRootPath, _myConfig.NomePastaImagensProdutos + "\\", fname);
